...
included file GUIDE.ORG (or read the first parts of the [[http://blocky.io/reference.htm][online Blocky
reference manual]]) to get an overview of the language syntax. Then look
through BLOCKS.LISP and branch out from there. I've placed cross
