** TODO elisp for grabbing slime-inspect for uuid at point
** TODO [#B] allow to remove temporary menus and stuff on loading (edit versus play)
** TODO [#C] implement make-process coroutines
