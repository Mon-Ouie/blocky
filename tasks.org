** TODO Self language
** TODO lower-right-corner resize handle decorator
** TODO desktop wall morphic http://www.cs.ucsb.edu/~urs/oocsb/self/release/Self-4.0/Tutorial/Morphic/Morphic/Kansas.html
** TODO [#A] Bring back old/forms.lisp spreadsheet
** TODO [#A] generic folding hierarchical list widget with indentation and headlines, a la orgmode 
*** TODO closable dialog decorator w/X button
...
** TODO [#A] defblock link <--- to another wikipage or something
** TODO [#A] define-method "block" has argument names as inputs
...
*** TODO defblock block --- defining new blocks with a block.
*** TODO defblock sprite --- defining sprites
*** TODO defblock with (introduce local vars) 
*** TODO defblock resource (a stand-in reference to a resource)
**** TODO should resources be full-fledged objects? 
*** TODO defblock var  (for lisp vars, script vars, proto names, and fields)
...
** TODO [#A] test raw string entry
** TODO [#A] General purpose easy dialog box maker
*** TODO dialog boxes for project save/load!
*** TODO dialog boxes are fancy SEND blocks that send to *system*
** TODO [#A] escape key hide/show terminals/menus
** TODO [#A] allow string-valued method fields. resource id's of method block, uuid?
...
*** TODO contains
** TODO [#B] rename RUN to EVALUATE
** TODO [#B] palette widget is a hide-able sidebar with tabs, where you pull off pieces Library / Variables / Methods / Prototypes
*** TODO generic sidebar widget can inspect its argument (topleft socket as with send)
