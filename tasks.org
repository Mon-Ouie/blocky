* TODO Screencast where a game is developed from scratch with Defresource improvements

** TODO grab a couple of images

** TODO make a wall that stops bullets
** TODO resizeable wall
** TODO standardized check-if-it's a kind-of 


** TODO random-colored brick
** TODO animated brick
** TODO wandering enemy
** TODO player with arrow key movement
