...
(define-prototype cell ()
  ...
  (widget :initform nil)
  (image :initform nil :documentation "Image to display. either a resource name string, or an IOMACS image object.")
...
Although a game built on IOMACS can define whatever categories are
...
(define-method draw cell (x y image)
  "Use IOMACS drawing commands to render a presentation of this cell at
