** TODO [#A] fix listener prompt cursor always resetting to column 0 upon focus
** TODO [#A] Turn on UNICODE key translation
** TODO [#B] emacs-like M-x pop up commandline/status (with messages widget. custom listener)
** TODO [#B] trigger context menu items with left click, make block with control-click/right-click
** TODO [#A] easily close menus with X in corner
** TODO [#B] universal morphic halo?
...
** TODO [#C] visually indicate clicked send blocks
