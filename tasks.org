...
** TODO [#A] don't change layers when dragging an object
** TODO [#A] Better explanation of blocks
** TODO [#A] Show how to make worlds programmatically
** TODO [#A] prevent objects leaving quadtree
** TODO [#B] improve defresource and call it define-resource
** TODO [#B] Working map editor
** TODO [#B] Fix able to pull out system menus
** TODO [#B] Show basic workflow in a video
** TODO [#B] rewrite prototype explanation to include more clear language, relevant to games, and more 
