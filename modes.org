...
* TODO bpolhttp://c2.com/cgi/wiki?ForthMacro
...
*** http://concatenative.org/wiki/view/Concatenative%20language
*** TODO DICTIONARY of items. how to define new items.
* VISUAL PROGRAMMING WITH THE KEYBOARD. visiprog does not require mouse.
** TODO define the widgetbuffer thing as an embeddable block, not a whole buffer type?
