...
** TODO [#A] hitting Lambda handle for a var ref
** TODO [#A] don't deselect listener when dropping
** TODO [#A] fix Control keybindings
...
** TODO [#B] resource-defining block-ui
