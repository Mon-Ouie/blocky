...
** TODO fix monitors don't collide properly with walls
...
** TODO Catch ball to recover energy
** TODO Deflect ball with trail
...
** TODO [#B] Collide any object that leaves the outermost bounding box
