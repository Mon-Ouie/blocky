*** TODO Read me first: F1, then click on any object for help
** TODO [#B] popup tape-flag/balloons to show you where you are, like hints about M-x window
*** TODO em-dash and en-dash for uniform layout

*** TODO interface flags, like colored tape flags with white txt 
** TODO terminal window can be moved around and resized
