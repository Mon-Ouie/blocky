* A.U.R.A.
** TODO AAA production values all the way through
** TODO manage oxygen, battery, ammo
** TODO dual analog stick control
** TODO z-depth fog, blur, and mask out a binocular circle, lensflare, liquid creatures w tentacles, projection
** TODO more maneuverability on ground? indoor locales
** TODO descend, lay nuke bomb, rise, detonate

** TODO [#A] MODELINE: more subtle handles/menus on the listener bar, show wiki page modeline etc
** TODO [#A] clickable project menu on modeline
** TODO [#A] clickable buffer id menu
** TODO [#A] show object data right-justified when selected 
*** DONE visually indicate which layer something is in
    CLOSED: [2012-03-22 Thu 07:46]
** TODO [#B] turn X and Y into separate labeled entries?
