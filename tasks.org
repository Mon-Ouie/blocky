...
** (let ((documentation-template:*target* #P"~/blocky.html")) (documentation-template:create-template :blocky))
** TODO [#B] Try to write a description of Blocky/morphic model
** TODO [#B] Show lisp implementation name etc
