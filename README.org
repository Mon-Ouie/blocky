...
Blocky can be found at our website, [[http://blocky.io][blocky.io]].
...
included file GUIDE.ORG (or read the web version at
http://blocky.io/guide.html ) to get an overview of the language
syntax. Then look through BLOCKS.LISP and branch out from there. I've
placed cross references wherever possible. 
