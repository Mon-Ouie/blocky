* TODO USABLE ALPHA RELEASE OF IOFORMS
** TODO [#A] use assertions to diagnose (unplug failure) not being able to pull out sprites (or any top item) from list
** TODO display name of current project / Unnamed project as prompt
** TODO [#A] more scratch/byob blocks
** TODO project settings dialog for configuring *screen-width* and *resizable* etc
...
** TODO splash screen with basic info
** TODO tutorial
