...
*** TODO add all missing keyboard characters
*** TODO [#A] test input boxes
*** TODO [#A] Generic block type should be able to send any message, with typed arg block wid
*** TODO [#A] dialog boxes for project save/load!
*** TODO [#A] test input computation and make sure %results has enough room
