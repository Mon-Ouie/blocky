* TODO Lightning Talk video 2
** TODO textbox
** TODO references

* TODO Review syntax and visual design

** TODO 

* BETA RELEASE EXECUTION PLAN

** TODO [#B] simple schedulers: later-do, later-when, later-until
*** TODO later-do and do-at-time macros evolve to a closure block that sends the supplied method
*** TODO later-when checks a condition (whether some other method returns non-nil)
** TODO Revise and simplify menus, more like Squeak
** TODO define-block PALETTE
** TODO buttons on palette
** TODO [#A] Complete the core language model (define blocks and methods visually)
*** TODO complete and test define-method block
** TODO [#A] Implement basic blocks library
*** TODO [#A] Test sprites with worlds
*** TODO [#B] incorporate turtle graphics code into base block prototype (for implementing move/turn/point-in-direction 
** TODO [#A] Ensure full and proper functioning of halos
*** TODO [#A] collapsed windows
** TODO [#C] DEFINITION indicator (three dots in a triangle like Therefore, or an EQUAL?)
** TODO [#B] Merge windows.lisp with shell code 
** TODO [#B] Restore basic collision detection functionality
** TODO [#B] Fix as much of the buglist as possible
** TODO [#B] Menus/dialogs for all basic project save/load stuff
...
* BUGS
** TODO [#B] Fix crash on wrong color names
...
** TODO make a list derivative whose first element is pinned for eval (VISUAL LAMBDA LIST?)
