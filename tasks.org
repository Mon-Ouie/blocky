* TODO Syntax demo
** TODO allow message stacking
** TODO add schemata to more methods
** TODO renaming message triggers schema lookup / argument change
** TODO ephemeral context menu that disappears when you click the background2
** TODO dividers for which class methods came from (union field)
** TODO tighten up message layout

** TODO error block appearing to right-of browser
...
** TODO simple object reference for "self" "world" and arbitrary ones
