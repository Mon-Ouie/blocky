...
*** TODO review vmacs.lisp and get basics working
*** TODO define block
*** TODO define method
*** TODO simple scheduler: later-do
...
* BUGS
** TODO [#A] Fix list %frozen not working
** TODO [#A] Fix first drag of object after creating halo causes jump in position 
