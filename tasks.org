...
** TODO clickable project menu on modeline
** TODO clickable buffer id menu
** TODO turn X and Y into separate labeled entries?
** TODO show object data right-justified when selected 
