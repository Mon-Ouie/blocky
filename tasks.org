...
** TODO defun holding-shift
** TODO semi-transparent smoke glass sidebar a la etoys
** TODO generic proportional and table layouts  
** TODO collapse windows
** TODO halos
*** TODO trash (top left)
*** TODO resize (bottom right)
*** TODO menu
*** TODO reference
*** TODO collapse
*** TODO pick up
...
* TODO Import window code and make a basic halo
** TODO review window code and adjust buffer API as appropriate
...
*** world is a type of buffer
*** window is something you open onto a buffer , in the shell

* THOUGHTS
* BUGS
** TODO Fix %TARGET not being set on menu items
** TODO Fix error handling: use error message bubbles with X close box and (backtrace) button?
** TODO Fix listener history errors
** TODO Fix missing entries in send block?? what's happening
** TODO Fix missing labels on defblock's child entries
** TODO Fix Control-E etc not working in textbox
** TODO Fix not traversing line break with C-f and C-b
** TODO Fix no blue dot movement in example2
** TODO Fix ellipsis not displayed on menu items until highlight
** TODO Fix crash when error in init file
** TODO Fix init file name (use blocky-init.lisp or ~/.blocky)
** TODO Fix crashes with tab and shift-tab navigation
* FEATURES
** TODO collapsible windows a-la-squeak
** TODO make reference ==> make tile?
...
** TODO [#B] Blocky in-engine inspector
