** TODO allow string-valued method fields. resource id's of method block, uuid?
** TODO (input :foo)  named input access.
** TODO fix input-widths
** TODO allow varying inputs length (i.e. no schema)
** TODO draw-socket should draw types
** TODO inputs and schema should be plists?
** TODO [#B] Rework block layout and make clicking/dragging work
** TODO [#A] Revise blocks execution model re:schema (see below)
** TODO [#B] Create DEFBLOCK block
** TODO [#A] Revise widgets.lisp for OpenGL
** TODO [#B] yellow comment sticky note boxes
** TODO [#B] AABB-tree (axis-aligned bounding-box)
** TODO [#B] Implement this GRAPH UI example:
