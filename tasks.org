** TODO Add TTF string drawing support
** TODO allow #RRGGBB color spec in resources
** TODO Port blocks.lisp to OpenGL
** TODO Revise blocks execution model re:schema (see below)
** TODO Revise widgets.lisp
** TODO Implement this GRAPH UI example:
