*** TODO test input boxes
*** TODO entry support before-label and after-label options/props
*** TODO test input computation and make sure %results has enough room
*** TODO auto define (%field object) functions? mappable
*** TODO Generic block type should be able to send any message, with typed arg block wid
