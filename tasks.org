...
** TODO keep similar to existing collision system for default. each object holds its collisions, not hash table (which was inefficient
...
* TODO  tigtesters: cpw, tacoxtreme 
