...
** TODO [#A] Fix clicking-on-background bug
** TODO [#B] highlight menu items (hover)
** TODO [#B] menu bar widget appears at top left when mouse goes there
...
** TODO [#B] ALPHA issues for PNG images
