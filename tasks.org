...
** TODO [#A] simple example, something to copy and tweak
*** TODO show both ways of writing define-block (with super and without)
** TODO [#A] change *compass-directions* to just *directions*, up down upright downleft... as in dance.lisp
** TODO add more docstrings for world.lisp
** TODO [#A] uniform x y ordering for all math funcs
** TODO [#B] Pathfinding and line-of-sight
