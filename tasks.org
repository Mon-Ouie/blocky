...
** TODO sys menu should allow pin/unpin and remember relative screen loc
** TODO pause and unpause simulation
...
** TODO [#A] Halo item and hotkey for moving objects down into world
...
** TODO [#B] Show result somewhere when clicking eval bang handle
