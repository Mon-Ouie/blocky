...
** TODO [#A] defblock FORM: a generic folding hierarchical list widget with indentation and headlines, a la orgmode 
*** TODO [#A] explicit "save" and "compile" buttons 
*** TODO [#A] palette widget is a hide-able sidebar with tabs, where you pull off pieces Library / Variables / Methods / Prototypes
...
** TODO [#B] script wiki database (like the file system)
...
*** TODO contains
** TODO [#B] lower-right-corner resize handle decorator
