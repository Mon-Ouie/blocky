...
** DONE [#A] self variable blocks
   CLOSED: [2012-03-04 Sun 17:18]
** TODO [#A] (browse-method 
** TODO [#A] local variable palettes that can also name the func/closure
**** TODO locked to 0,0 position

** TODO [#A] literal 'ladybug new
** TODO [#A] world variable
** TODO [#A] lisp literal variables 
