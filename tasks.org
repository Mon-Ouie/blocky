** TODO properly close database by removing all non-named objects when quitting project
** TODO create package and proto-name prefix for all projects (use projectname)
