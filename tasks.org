...
** TODO report cl-opengl examples crashing on other pc to cl-opengl listxxc
** TODO navajo white city with text overlay about gas giant xalcyon
** TODO depth of field mipmapping to color distant objects with atmosphere distance/haze?

** TODO try debian wheezy on pod
...
** TODO rework simple collision detection--- abstract it out and let objects handle it
** TODO use turtle to program polygon vertices and shit a la fluxus
