...
** TODO replace unprintable lambdas with lambda blocks in %events
** TODO register properly all UUID on deserialization
** TODO allow to remove temporary menus and stuff on loading (edit versus play)
...
** TODO change PROJECTNAME.iof to index.iof
