...
** TODO Fix shell not responding to window resize properly
** TODO [#A] Adapt line-of-sight code to new collision system
** TODO [#A] Adapt pathfinding code to new collision system
...
** TODO [#C] Don't require .blocky suffix for project dir
