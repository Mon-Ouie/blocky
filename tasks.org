** TODO [#A] enable UNICODE in terminals
...
can bind to the windows one yourself I use #'glfw:get-proc-address /
me, I add "." and "%CD%" to cffi's foreign directory search list...
