...
** TODO [#A] VAR entry
** TODO [#A] project settings dialog for configuring vars like *screen-width* and *resizable* etc
...
** TODO [#A] System browser for choosing what to define methods on 
** TODO [#A] Better language tutorial project
** TODO [#B] "quit without saving?" dialog
