...
** TODO try caching quadtree node as a shortcut to delete
** TODO Fix enemies that shoot before moving disappearing after shot
** TODO symmetrical monadic procedural turtle designed aliens with png pieces laid down by turtles.
** TODO behavior tokens evolve too
** TODO fences red/magenta flash
** TODO Make objects that spawn enemies. 
** TODO Growing mismunch corruption clouds
** TODO pick up chips as pac pellets
** TODO bombs in the level that blow up stuff
** TODO drag an item behind you 
** TODO chip = currency as XP to pick up after kills
** TODO universe = quadtree turtle based world gen/management 
** TODO very simple level 1 with improved tandy colors
** TODO biclops jump/stomp with big boom sound
** TODO fix monitors don't always collide properly with walls
** TODO get line-of-sight working again
** TODO level builder concepts---LOGO again? 
** TODO Basic walled off room. draw barrier around level
** TODO Barrier around interior, possibly with rooms/items inside
** TODO Break bricks to find items
** TODO Biclops
** TODO Monitor enemy from XONG 1.4
** TODO Absorb enemy bullet with trail
** TODO 2nd enemy
** TODO ESCAPE to restart/regenerate
** TODO fictional emails
...
** TODO [#B] Fix key release handling
