...
Blocky is relatively stable at this point, but documentation is
somewhat lacking.
...
- listener.lisp: Lisp data entry, data objects, and command processing
- worlds.lisp: simulation of interacting objects
- path.lisp: A-star pathfinding on a grid
- syntax.lisp: visual macros
...
- build-win32.lisp: build script for win32 (obsolete)
