...
Sprites are also based on cells. See `defsprite'.")
  ...
  (widget :initform nil :documentation "IOFORMS widget object, if any.")
...
The Action Points system is IOFORMS's model of roguelike time; Time is
...
First your turn comes up, and IOFORMS waits for your input.  Once you
...
still alive, the player phase begins again.
 ...
 (In realtime mode, IOFORMS does not wait for input.)
