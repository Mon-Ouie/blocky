...
** TODO [#C] System browserd

* BUGS
** TODO [#A] Fix listener prompt not laying out after character insertion
** TODO [#A] Fix STRING not being set properly without quotes
** TODO [#A] Fix missing labels on defblock's child entries (eval going wrong?)
** TODO [#B] Fix ENTER%%ENTRY being called twice because of ON-LOSE-FOCUS
...
** TODO [#C] Fix no blue dot movement in example2
...
** TODO [#C] semi-transparent smoke glass s idebar a la etoys
* THOUGHTS
