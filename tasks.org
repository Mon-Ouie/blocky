* TODO Working map editor
* TODO Fix able to pull out system menus
* TODO fix crash on deleting system menu
* TODO create unified error handling dialog
* TODO Also show how to make worlds programmatically
* TODO do something about objects leaving quadtree <-- restrict them?
* TODO Show basic workflow in a video
* TODO Think and review ALL this todo list
...
* BETA RELEASE
** Documentation
*** TODO rewrite prototype explanation to include more clear language, relevant to games, and more 
*** TODO import vomac example from video
*** TODO test examples
*** TODO import xeng remix
*** TODO tag release
* TODO explicit pull-up handle instead of auto-pullup
* Creating a cool game editor with tight emacs integration
***  and then growing it into scratch-squared!
** TODO review smalltalk-elements, byob for TOP LEVEL area identifications
** TODO define-block-macro resource
*** TODO auto finding of new resources (.png, .wav handlers etc) in a dir
** TODO flesh out basic Projects operations dialogs
...
** TODO Pretty sexy black rounded corner notifications
...
** TODO buttons for toggle pin,freeze
...
** TODO [#B] copyright notice 
** TODO [#B] Fancy credits 
** TODO [#B] basic help
...
** TODO [#B] System Browser in the menu, for choosing what to define methods on (or blocks from)
