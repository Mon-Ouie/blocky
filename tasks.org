...
** TODO draw standard svg or bitmap icons for errors, informations, questions, and TREE ARROWS
...
*** TODO fix inconsistent menu highlighting (may have to do with %focused or %hover or %selected being set to nil)
*** TODO defblock field 
