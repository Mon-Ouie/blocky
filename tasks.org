** TODO Fix funny unicode characters getting used instead of SDL keys for bindings like RET and BACKSPACE
** TODO Fix context-menu: method schema not being found when it's inherited
