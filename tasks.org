...
** TODO GLSL https://github.com/jtza8/interact/blob/master/src/filter.lisp http://www.swiftless.com/glsltuts.html
** TODO sexy black gradient system menu (gradient patch) pops up from corner---not a menu bar
