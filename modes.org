...
** TODO rename SHELL to SCRIPT? or something similar. CODE? SENTENCE?

** TODO [#A] SHELL is a widget that can be arranged in the buffer with test objects
** TODO [#A] create shell when you click on the background, delete it if nothing was typed
...
** TODO SHELL widget instantiates as a blinking cursor 
*** TODO 
